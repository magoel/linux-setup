...
SCRIPTPATH="`pwd`";
popd  > /dev/null
#echo "srcipt=[${SCRIPTPATH}]"
#echo "pwd   =[`pwd`]"
export _MANISH_HOME=$SCRIPTPATH
...
# expand environment variable in dirpath
shopt -s direxpand
...
###########################
#Preserve history across terminal sessions and reboots
# Avoid duplicates
